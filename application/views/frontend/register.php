                ...
                <form id="form_register" action="<?php echo BASE_URL('proses/post_account'); ?>" method="POST" class="check-out-form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="wrap-different-address">
                                    <input class="input-form" type="text" id="fullname" name="fullname" autocomplete="off" required />
                                    <div class="row">
                    ...
                    <div class="payment-methods">
                        ...
                        <button type="button" id="bt_complete" class="place-order-btn" onClick="complete_register()">
                            <i class="fa fa-check"></i> REGISTER NOW
                        </button>
            ...
            $.ajax({
                ...
                success: function(respon) {
                    if (respon.status == 'success') {
                        swal("Success", 'Please, Login into your account', "success");
                        $("#fullname").val('');
                        $("#phone").val('');
                        $("#email").val('');
                        $("#password").val('');
                        ...
                        swal("Failed", respon.message, "error");
                    }
                }
            });
        }
