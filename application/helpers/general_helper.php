    ...
    function dateDiff($time1, $time2, $precision = 6) {
        ...
        foreach ($diffs as $interval => $value) {
          ...
          if ($value > 0) {
            ...
            switch ($interval) {
                case 'year': $interval = 'tahun'; break;
                case 'month': $interval = 'bulan'; break;
                case 'day': $interval = 'hari'; break;
                case 'hour': $interval = 'jam'; break;
                case 'minute': $interval = 'menit'; break;
                case 'second': $interval = 'detik'; break;
